...
export const LightArtPiece = IDL.Record({
  'id' : IDL.Text,
...
export const idlService = IDL.Service({
  ...
  'getAllArtworks' : IDL.Func([], [IDL.Vec(LightArtPiece)], ['query']),
  'getArtwork' : IDL.Func([IDL.Text], [IDL.Opt(LightArtPiece)], ['query']),
...
export const idlFactory = ({ IDL }) => {
  ...
  const LightArtPiece = IDL.Record({
    'id' : IDL.Text,
    'metadata' : NFTMetadata,
    'image' : ExternalBlob,
  });
