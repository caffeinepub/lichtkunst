...
import type { ExternalBlob as _ExternalBlob, LightArtPiece as _LightArtPiece, NFTMetadata as _NFTMetadata, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllArtworks(): Promise<Array<LightArtPiece>> {
        if (this.processError) {
            try {
    ...
    async getArtwork(arg0: string): Promise<LightArtPiece | null> {
        if (this.processError) {
            try {
    ...
    async uploadArtwork(arg0: ExternalBlob, arg1: string, arg2: string): Promise<LightArtPiece> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadArtwork(await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
                return from_candid_LightArtPiece_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
async function from_candid_LightArtPiece_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _LightArtPiece): Promise<LightArtPiece> {
...
async function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_LightArtPiece]): Promise<LightArtPiece | null> {
    return value.length === 0 ? null : await from_candid_LightArtPiece_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_LightArtPiece>): Promise<Array<LightArtPiece>> {
    return await Promise.all(value.map(async (x)=>await from_candid_LightArtPiece_n11(_uploadFile, _downloadFile, x)));
}
